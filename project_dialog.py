...
class ProjectEditorDialog(wx.Dialog):
    ...
    def __init__(self,parent,service,church_id,project_id=None):
        ...
        self.number.SetName("project_number"); self.name.SetName("project_name"); self.status.SetName("project_status"); self.priority.SetName("project_priority")
        ...
        buttons=wx.BoxSizer(wx.HORIZONTAL); save=wx.Button(panel,label="Save Project",name="project_save"); buttons.Add(save); buttons.AddStretchSpacer(); buttons.Add(wx.Button(panel,wx.ID_CLOSE,"Close",name="project_close")); outer.Add(buttons,0,wx.EXPAND|wx.LEFT|wx.RIGHT|wx.BOTTOM,12); panel.SetSizer(outer)
