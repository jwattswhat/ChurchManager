...
| 11 | In progress | [Groups, committees, classes, and ministry teams](ChurchManager.GroupsMembership.Specification.md) | Migration 106 normalized the database. The permission-filtered Groups workspace supports Group creation, same-congregation dated membership, preserved membership endings, and dated role assignment. Catalog maintenance, meetings, attendance, communication preparation, and reports remain. |
