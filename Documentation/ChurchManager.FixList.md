...
| 13 | In progress | [Custom profile fields and controlled tags](ChurchManager.CustomProfileFields.Specification.md) | Schema, permissions, application-neutral JSForm host, ChurchManager services, full lifecycle-aware definition inspection/editing, Person/Family value editing, bounded type-aware search, and the permission-filtered approved listing report are implemented; import/export and final visual acceptance remain. |
