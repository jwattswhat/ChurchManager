...
| 10 | In progress | [Import, export, and duplicate management](ChurchManager.DataManagement.Specification.md) | Duplicate review and explicitly mapped, non-writing CSV preview are implemented; guarded import, export, resolution, and portable archive phases follow. |
...
- **Status: in progress.** The central Data Management screen, conservative
  duplicate review, and explicit People/Families CSV mapping preview are implemented. Follow
