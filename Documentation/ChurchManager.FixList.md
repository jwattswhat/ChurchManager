...
| 14 | In progress | [Calendar integration](ChurchManager.CalendarIntegration.Specification.md) | The Event agenda, natural recurrence, neutral adapters, protected combined preview, and portable iCalendar export are implemented; publication tracking, optional Google publishing, and the future Project adapter remain. |
