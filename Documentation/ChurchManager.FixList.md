...
| 11 | In progress | [Groups, committees, classes, and ministry teams](ChurchManager.GroupsMembership.Specification.md) | Migration 106 normalized Groups and membership. Migration 107 adds separate meeting and attendance storage. The workspace supports Group and catalog maintenance, dated membership and roles, meeting history, preserved cancellation/rescheduling, roster attendance, meeting-only existing-Person guests, and anonymous head counts. Communication preparation and reports remain. |
