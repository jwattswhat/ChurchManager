...
| 14 | In progress | [Calendar integration](ChurchManager.CalendarIntegration.Specification.md) | Event agenda, natural recurrence, neutral adapters, protected preview, and iCalendar export are implemented. Migration 116 defines credential-free publication bindings; its repository, optional Google publishing, and the future Project adapter remain. |
