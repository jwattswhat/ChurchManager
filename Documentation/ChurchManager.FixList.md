...
| 10 | In progress | [Import, export, and duplicate management](ChurchManager.DataManagement.Specification.md) | Central duplicate review is implemented first; guarded import, export, resolution, and portable archive phases follow. |
...
- **Status: in progress.** The central Data Management screen and conservative,
  read-only person/family duplicate review are implemented. Follow
