...
| 11 | In progress | [Groups, committees, classes, and ministry teams](ChurchManager.GroupsMembership.Specification.md) | Migration 106 normalized the database. The permission-filtered Groups workspace supports Group creation, maintained local type/role catalogs, same-congregation dated membership, preserved membership endings, and dated role assignment. Meetings, attendance, communication preparation, and reports remain. |
