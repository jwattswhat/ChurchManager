...
| 13 | In progress | [Custom profile fields and controlled tags](ChurchManager.CustomProfileFields.Specification.md) | Schema, permissions, application-neutral JSForm host, ChurchManager services, full lifecycle-aware definition inspection/editing, Person/Family value editing, bounded type-aware search, approved listing report, stable-key export manifest, and previewed atomic import are implemented; final visual acceptance remains. |
