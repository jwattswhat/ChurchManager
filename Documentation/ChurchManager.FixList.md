...
| 11 | In progress | [Groups, committees, classes, and ministry teams](ChurchManager.GroupsMembership.Specification.md) | Migration 106 normalized the database. The main menu now opens a permission-filtered Groups workspace with Group creation and same-congregation dated membership entry. Role assignment, catalogs, meetings, attendance, communication preparation, and reports remain. |
