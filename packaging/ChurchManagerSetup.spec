...
"""PyInstaller specification for the installed ChurchManager setup entry."""
...
exe = EXE(
    ...
    name="ChurchManagerSetup", debug=False, bootloader_ignore_signals=False,
    strip=False, upx=False, console=False,
    icon=str(ROOT / "cm.ico"),
)
coll = COLLECT(
    exe, a.binaries, a.datas, strip=False, upx=False,
    name="ChurchManagerSetup",
)
