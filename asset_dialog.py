...
class AssetEditorDialog(wx.Dialog):
    ...
    def __init__(self,parent,service,church_id,asset_id=None):
        ...
        outer.Add(book,1,wx.EXPAND|wx.ALL,10); buttons=wx.BoxSizer(wx.HORIZONTAL); buttons.AddStretchSpacer(); save=wx.Button(panel,wx.ID_OK,"Save Asset"); buttons.Add(save,0,wx.RIGHT,8); buttons.Add(wx.Button(panel,wx.ID_CANCEL,"Cancel")); outer.Add(buttons,0,wx.EXPAND|wx.LEFT|wx.RIGHT|wx.BOTTOM,10); panel.SetSizer(outer); self._fill(); self.refresh_history()
    @staticmethod
